...
![Terminal](/terminal/terminal.png)

The terminal will show output in three sections. 

#### Component builder

![Terminal: component builder](/terminal/component-builder.png)
...
![Terminal: API runner](/terminal/api-runner.png)

The output of the [API](/api/introduction) is shown in the bottom left.

#### Client runner

![Terminal: Client runner](/terminal/client-runner.png)
...
![Editor: page selection](/editor/page-selection.png)
...
![Editor: widget tree](/editor/tree.png)
...
![Editor: client preview](/editor/client.png)
...
![Editor: widget configuration](/editor/config.png)
...
![Editor: variables](/editor/variables.png)
